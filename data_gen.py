...
np.savez('./data/JOBS/{}times_noisy_{}_jobs_1-1000.train.npz'.format(noise_scale, noise_dim),
         x=new_jobs_train_x_100,t=jobs_train['t'],yf=jobs_train['yf'],e=jobs_train['e'])
np.savez('./data/JOBS/{}times_noisy_{}_jobs_1-1000.test.npz'.format(noise_scale, noise_dim),
